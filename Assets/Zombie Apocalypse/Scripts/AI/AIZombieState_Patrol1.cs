...
public class AIZombieState_Patrol1 : AIZombieState
{
    ...
    [SerializeField] private float _turnOnSpotThreshold = 90.0f;
    ...
    public override AIStateType OnUpdate()
    {
        ...
        if (_zombieStateMachine.navAgent.isPathStale || !_zombieStateMachine.navAgent.hasPath || _zombieStateMachine.navAgent.pathStatus != UnityEngine.AI.NavMeshPathStatus.PathComplete)
        {
