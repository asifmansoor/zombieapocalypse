...
{
    [SerializeField] [Range(0, 10)] private float _speed = 2.0f; //1.0f;
    ...
    [SerializeField] private AudioSource _zombieSound = null;
    ...
    public override void OnEnterState()
    {
        ...
        if (_zombieSound != null && !_zombieSound.isPlaying)
            _zombieSound.Play();
    }
    ...
    public override AIStateType OnUpdate()
    {
        ...
        if (_zombieStateMachine.navAgent.isPathStale || (!_zombieStateMachine.navAgent.hasPath && !_zombieStateMachine.navAgent.pathPending) ||
